...
class UnsplashUserLikedPhotosPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Photo> {
        ...
        return try {
            val response = unsplashApi.getUserLikedPhotos(userName, position, params.loadSize)
            ...
            Log.e("Page Load Error", "Exception = ${e.message}", e)
            LoadResult.Error(e)
        }
    }
